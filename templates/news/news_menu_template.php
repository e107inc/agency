...
$NEWS_MENU_TEMPLATE['latest']['item']        = '<li class="list-group-item"><a class="e-menu-link latest" href="{NEWSURL}">{NEWSTITLE}</a> <span class="badge badge-primary">{NEWSCOMMENTCOUNT}</span></li>';
